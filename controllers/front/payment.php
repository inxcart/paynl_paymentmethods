...
//        parent::initContent();
        ...
        try {
            ...
            $shippingCostNoTax = $cart->getTotalShippingCost(null, false);
            if ($shippingCost != 0) {
                $taxClass = Pay_Helper::calculateTaxClass($shippingCost, $shippingCost - $shippingCostNoTax);
            ...
            if ($cart->gift != 0) {
                ...
                $packingCostNoTax = $cart->getGiftWrappingPrice(false);
                if ($packingCost != 0) {
                    $taxClass = Pay_Helper::calculateTaxClass($packingCost, $packingCost - $packingCostNoTax);
            ...
            if ($this->module->validateOnStart($paymentOptionId)) {
                $module->validateOrderPay((int) $cart->id, $statusPending, $total, $extraFee, $module->getPaymentMethodName($paymentOptionId), null, ['transaction_id' => $result['transaction']['transactionId']], (int) $currencyId, false, $customer->secure_key);
            }
